...
def _checkifflux_(csvfilename):
    return 'GPP_flux' in csvfilename
...
def _ts_run_(csvfilename,
    ...
    fluxgpp = _checkifflux_(csvfilename)
    ...
    if run_vpp == 1:
        output_settings_file_name = output_settings_file_name + 'settings_vpp.csv'
        ...
        output_settings_file_name = output_settings_file_name + 'settings_st.csv'
        settings_df.to_csv(output_settings_file_name, index=False)
