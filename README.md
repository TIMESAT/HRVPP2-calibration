...
Step 5: plot
```bash
python plot_vpp_points_by_triple_per_lc.py --csv output/ALL_VIs_SUMMARY_BY_LC_merged_with_score.csv --top-k 20 --min-per-group 3 --seapar-col seapar --annotate-setting
```
Step 6: best settings
```bash
python Best_settings_lc.py
```
