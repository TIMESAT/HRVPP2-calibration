...
input_folder = 'FAPAR/V5/timeseries/csv_lc_200m/'
output_folder = 'output/FAPAR/'

input_folder = 'GPP_flux/V2/gpp_cal/' # flux GPP
output_folder = 'output/GPP/'

input_folder = 'GPP_LUE/' # model GPP
output_folder = 'output/GPPmodel/'
...
for csv_file in csv_files:
    ...
    if find_site_lc_csv(extract_site_code(csv_file), "GPP_flux/V2/gpp_cal/") is None:
    ...
    lcname = Calvpp_ts_csv_functions_HRVPP2._ts_run_(input_file_path, output_yfit_file_path, output_vpp_file_path, output_png_path, "output/")
